...
import { Search, Check, X, AlertCircle, FileText } from 'lucide-react';
...
export default function HistorialCitas({ medico, lanzarAlerta }) {
  ...
  // Cita cuya nota clínica se está visualizando (null = modal cerrado)
  ...
  // Una cita queda "expirada" si su fecha ya pasó y sigue Pendiente o En progreso.
  // Esto rescata citas huérfanas (ej: el médico cerró el navegador sin finalizar la consulta).
    ...
    <div className="p-6 space-y-6 relative">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-xl max-w-md w-full space-y-4">
            <div className="flex items-start justify-between gap-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="text-sm font-bold text-slate-800">Nota Clínica</h3>
            ...
            <div className="bg-slate-50 border border-slate-100 rounded-xl p-4 max-h-64 overflow-y-auto">
              <p className="text-sm text-slate-700 leading-relaxed whitespace-pre-wrap">{notaVisible.nota_clinica}</p>
            </div>
          </div>
        </div>
      )}
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm space-y-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-between">
          ...
          {/* Se incluye "En progreso" para poder localizar citas que quedaron abiertas */}
          <div className="flex bg-slate-100 p-1 rounded-xl text-xs font-bold text-slate-500 w-fit flex-wrap">
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="text-xs text-slate-600 divide-y divide-slate-50">
                {citasFiltradas.map((cita) => {
                  ...
                  // Se permite resolver citas Pendientes y En progreso (incluidas las expiradas)
                      ...
                      <td className="py-3 text-center">
                        {permiteAcciones ? (
                          ...
                          <button
                            ...
                            title="Ver la nota clínica de esta consulta"
                          >
