...
export default function HomeDashboard({ medico, lanzarAlerta, iniciarLlamada, mostrarSoloEnlace }) {
  ...
  const esCitaInminente = (horaCita, modalidad, estado) => {
    if (!horaCita || modalidad !== 'Virtual' || (estado !== 'Pendiente' && estado !== 'En progreso')) return false;
          ...
          <div className="w-full">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="w-full bg-slate-100 rounded-full h-1.5 max-w-[100px]">
                <div className="bg-purple-500 h-1.5 rounded-full transition-all duration-500" style={{ width: `${porcentajeEficiencia}%` }}></div>
              </div>
            </div>
          </div>
        </div>
